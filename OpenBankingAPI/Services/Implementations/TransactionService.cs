...
namespace OpenBankingAPI.Services.Implementations
{
    ...
    {
        private OpenBankingDbContext _dbContext;
        ...
        public TransactionService(OpenBankingDbContext dbContext, ILogger<TransactionService> logger, IAccountService userService, IOptions<AppSettings> settings)
        {
            ...
            _bankSettlementAccount = _settings.OurBankSettlementAccount;
